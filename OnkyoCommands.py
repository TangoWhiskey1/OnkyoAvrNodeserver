...
from OnkyoUtils import ValueRange

COMMANDS = OrderedDict([('main', 
        OrderedDict([
    ('PWR', {'values': OrderedDict([
            ('00',   {'name': ('standby', 'off'), 'description': 'sets System Standby'}),
            ('01',   {'name': 'on', 'description': 'sets System On'}),
            ('ALL',  {'name': 'standby-all','description': 'All Zone(including Main Zone) Standby'}),
            ('QSTN', {'name': 'query', 'description': 'gets the System Power Status'})]),
        'name': 'system-power', 'description': 'System Power Command'}),
    ('AMT', {'values': OrderedDict([
        ...
        'name': 'audio-muting', 'description': 'Audio Muting Command'}),
    ('CMT', {'values': OrderedDict([
            ('aabbccddeeffgghhiijjkkllmm', {'name': 'aabbccddeeffgghhiijjkkllmm', 'description': 'sets Audio Muting by Channel\nxx=00 Muting Off\nxx=01 Muting On\nxx=TG Muting Wrap-Around\nfor not exist channel is always 00.\n\naa:Front Left\nbb:Front Right\ncc:Center\ndd:Surround Left\nee:Surround Right\nff:Surround Back Left\ngg:Surround Back Right\nhh:Subwoofer 1\nii:Height 1 Left\njj:Height 1 Right\nkk:Height 2 Left\nll:Height2 Right\nmm:Subwoofer 2'}),
            ('QSTN', {'name': 'query', 'description': 'gets the Audio Muting State'})]),
        'name': 'audio-muting-by-channel', 'description': 'Audio Muting by Channel Command'}),
    ('SPA', {'values': OrderedDict(
        ...
        'name': 'speaker-a', 'description': 'Speaker A Command'}),
    ('SPB', {'values': OrderedDict([
            ('00', {'name': 'off', 'description': 'sets Speaker Off'}),
            ('01', {'name': 'on', 'description': 'sets Speaker On'}),
            ('UP', {'name': 'up', 'description': 'sets Speaker Switch Wrap-Around'}),
            ('QSTN', {'name': 'query', 'description': 'gets the Speaker State'})]),
        'name': 'speaker-b', 'description': 'Speaker B Command'}),
    ('SPL', {'values': OrderedDict([
            ('SB', {'name': 'surrback',  'description': 'sets SurrBack Speaker'}),
            ('FH', {'name': ('front-high', 'surrback-front-high-speakers'), 'description': 'sets Front High Speaker / SurrBack+Front High Speakers'}),
            ('FW', {'name': ('front-wide', 'surrback-front-wide-speakers'),  'description': 'sets Front Wide Speaker / SurrBack+Front Wide Speakers'}),
            ('HW', {'name': ('front-high-front-wide-speakers'), 'description': 'sets, Front High+Front Wide Speakers'}),
            ('H1', {'name': 'height1-speakers', 'description': 'sets Height1 Speakers'}),
            ('H2', {'name': 'height2-speakers', 'description': 'sets Height2 Speakers'}),
            ('BH', {'name': 'back-height1-speakers', 'description': 'sets Back+Height1 Speakers'}),
            ('BW', {'name': 'back-wide-speakers', 'description': 'sets Back+Wide Speakers'}),
            ('HH', {'name': 'height1-height2-speakers', 'description': 'sets Height1+Height2 Speakers'}),
       ...
       'name': 'speaker-layout', 'description': 'Speaker Layout Command'}),
    ('MVL', {'values': OrderedDict([
            ((0, 200), {'name': None,'description': u'Volume Level 0.0 \u2013 100.0 ( 0.5 Step In hexadecimal representation)'}),
            ((0, 100), {'name': 'vol-0-100,', 'description': u'Volume Level 0 \u2013 100 ( In hexadecimal representation)'}),
            ((0, 80), {'name': None,  'description': u'Volume Level 0 \u2013 80 ( In hexadecimal representation)'}),
            ((0, 50), {'name': 'vol-0-50,', 'description': u'Volume Level 0 \u2013 50 ( In hexadecimal representation)'}),
            ...
            ('DOWN1', {'name': 'level-down-1db-step', 'description': 'sets Volume Level Down 1dB Step'}),
            ('QSTN', {'name': 'query', 'description': 'gets the Volume Level'})]),
        'name': 'master-volume', 'description': 'Master Volume Command'}),
    ('TFR', {'values': OrderedDict([
            ('B{xx}', {'name': 'b-xx', 'description': 'Front Bass (xx is "-A"..."00"..."+A"[-10...0...+10 1 step]'}),
            ('T{xx}', {'name': 't-xx', 'description': 'Front Treble (xx is "-A"..."00"..."+A"[-10...0...+10 1 step]'}),
            ('BUP', {'name': 'bass-up', 'description': 'sets Front Bass up(1 step)'}),
            ('BDOWN', {'name': 'bass-down', 'description': 'sets Front Bass down(1 step)'}),
            ('TUP', {'name': 'treble-up', 'description': 'sets Front Treble up(1 step)'}),
            ('TDOWN', {'name': 'treble-down', 'description': 'sets Front Treble down(1 step)'}),
            ('QSTN', {'name': 'query', 'description': 'gets Front Tone ("BxxTxx")'})]),
        'name': 'tone-front', 'description': 'Tone(Front) Command'}),
